...
void WS2812_Refresh(void)
{
    ...
    calcBuf_SPI();
    HAL_SPI_Transmit_DMA(&hspi3, WS2812_SPI_BUF, ARRAY_SIZE(WS2812_SPI_BUF));
#endif
}
...
{
    for (uint32_t i = 0u; i < WS2812_NUM_LEDS_CH1; i++)
    {
    	WS2812_HSV_t hsv = {
            .h = phase + i * 360u / (WS2812_NUM_LEDS_CH1-1),
            .s = 100,
            .v = 50
        };
        WS2812_One_HSV(i, hsv, 0);
    }
}
